package com.yash.oops.problem1;
	...
	void InitializePerson()
	   {
		System.out.println("----------Initializing Person using super in Customer -----------");
		   ...
		   super.setPname("Nikhil");      System.out.println("Person Name    = "+super.getPname());
		   super.setPaddress("Karade");  System.out.println("Person address = "+super.getPaddress());
